...
| | Answer |
| --- | --- |
| **Is anything missing?** | ✅ No. Everything Lichess records about a game is kept, on all five months. |
| **Is anything made up?** | ✅ No. Where Lichess left something blank, it is still blank. Nothing was filled in with a guess. |
| **Do the few numbers I work out myself hold up?** | ✅ Yes. Things like how many moves a game lasted were worked out a second time from the moves themselves, and every one agreed. |
...
character of the file changes. Below are the fingerprints of the exact files I checked, so you can
download a month yourself and confirm you got the same file I did.
...
It covers the five months above and no others. Lichess has more, and I am still saving more of
them. Where only a sample was checked, it speaks for the games it picked.
